    ...
    <section className="relative w-full overflow-hidden bg-[#071322] text-surface-white -mt-2 pt-10 sm:pt-12 lg:pt-14 pb-28 sm:pb-32 lg:pb-36">
      ...
      <div className="relative z-10 max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-white leading-[1.15] max-w-5xl mb-3 sm:mb-4 drop-shadow-[0_4px_16px_rgba(0,0,0,0.8)]">
          ...
          <span className="block mt-1 sm:mt-2 text-transparent bg-clip-text bg-gradient-to-r from-[#FFC247] via-[#FF7A00] to-[#FF4500] drop-shadow-[0_4px_24px_rgba(255,122,0,0.45)]">
            Vinhomes Smart City
          </span>
        </h1>

        {/* Sub-headline description */}
        <p className="text-sm sm:text-base md:text-lg text-slate-200 font-medium max-w-2xl leading-relaxed mb-7 sm:mb-8 drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
          Tìm nhanh theo phân khu, mức giá, diện tích và nội thất. <br />
          <span className="text-amber-300 font-semibold">100% Giá gốc chủ nhà</span> • Không phí môi giới • Xem nhà 24/7.
        </p>

        {/* KPI Metric Counter Bar - Perfectly balanced glass cards */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 w-full max-w-4xl mb-4 sm:mb-6">
          <div className="bg-slate-900/60 backdrop-blur-md border border-white/15 rounded-2xl p-4 sm:p-5 flex flex-col items-center justify-center hover:border-white/30 transition-all shadow-lg hover:shadow-xl">
            <span className="text-3xl sm:text-4xl font-black text-white tracking-tight">269</span>
          ...
          <div className="bg-slate-900/60 backdrop-blur-md border border-emerald-500/25 rounded-2xl p-4 sm:p-5 flex flex-col items-center justify-center hover:border-emerald-500/50 transition-all shadow-lg hover:shadow-xl">
            <span className="text-3xl sm:text-4xl font-black text-emerald-400 tracking-tight">214</span>
          ...
          <div className="bg-slate-900/60 backdrop-blur-md border border-sky-500/25 rounded-2xl p-4 sm:p-5 flex flex-col items-center justify-center hover:border-sky-500/50 transition-all shadow-lg hover:shadow-xl">
            <span className="text-3xl sm:text-4xl font-black text-sky-400 tracking-tight">8</span>
          ...
          <div className="bg-slate-900/60 backdrop-blur-md border border-amber-500/25 rounded-2xl p-4 sm:p-5 flex flex-col items-center justify-center hover:border-amber-500/50 transition-all shadow-lg hover:shadow-xl">
            <span className="text-3xl sm:text-4xl font-black text-amber-400 tracking-tight">5.5 - 18.5</span>
